...
import Image1 from "./LoginPagePhotos/odtu-1.jpg";
import Image2 from "./LoginPagePhotos/odtu-2.jpg";
import Image3 from "./LoginPagePhotos/odtu-3.jpg";
            ...
            <Grid container component="main" className={classes.root}>
                ...
                <Grid item xs={12} sm={8} md={4} component={Paper} elevation={6} square>
                    <div className={classes.paper}>
                        <p  style={styleObj}><img src="metu.png" alt="Example1" width="50" height="50"/> <br/> Online Education Tool</p>
                        ...
                        {this.state.notsend ? <Form className={classes.form} noValidate>
                            ...
                            <Box mt={5}>
                                <Typography variant="body2" color="textSecondary" align="center">
                                    {'Copyright © '}
                                    <Link color="inherit" href="https://oet.ceng.metu.edu.tr/">
                                        OET
                                    </Link>{' '}
